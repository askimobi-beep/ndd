        ...
        <div className="w-full space-y-8">
          <div className="rounded-[28px] bg-gradient-to-r from-primary via-secondary to-[#1f3c97] p-8 text-white shadow-[0_24px_60px_rgba(0,87,231,0.22)]">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-blue-100">Customer Panel</p>
                <h2 className="mt-3 text-3xl font-semibold lg:text-4xl">Customer Management Dashboard</h2>
                <p className="mt-3 max-w-2xl text-sm leading-7 text-blue-100">
                  Manage customer records and keep profile details ready for the next workflow phase.
                </p>
              </div>
            ...
            <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
              <div className="space-y-4">
                <div>
                  ...
                  <h3 className="mt-2 text-2xl font-semibold text-slate-900">Refine customer records</h3>
                </div>
